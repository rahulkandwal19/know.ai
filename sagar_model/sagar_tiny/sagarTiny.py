...
llm_pool = [Llama(model_path="sagartiny.gguf", n_ctx=2048, n_threads=4) for _ in range(MODEL_POOL_SIZE)]
...
def make_prompt(context: str, question: str) -> str:
    context = context.strip() if context else "You are a assistant in Ocean Research Center."
